...
class TitleScreenUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isSmall = size.width < 600 || size.height < 600;
    final double vPad = isSmall ? 12 : 40;
    final double hPad = isSmall ? 12 : 50;
          ...
          children: [
            ...
            TopLeft(
              child: UiScaler(
                ...
                referenceHeight: isSmall ? 800 : 1080,
                referenceWidth: isSmall ? 360 : 1920,
                child: _TitleText(),
              ),
            ),
        ...
        return TickingBuilder(
          builder: (context, time) {
            return AnimatedSampler((image, size, canvas) {
              ...
              final shader = shaders.ui.fragmentShader();
              shader
